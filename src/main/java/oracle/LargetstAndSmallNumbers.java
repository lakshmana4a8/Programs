...
public class LargetstAndSmallNumbers {
	public static void main(String[] args) {
		String n = "$";
		System.out.println(n.lastIndexOf("45"));
		System.out.println(n.lastIndexOf("43"));
		
		
		System.out.println(Integer.MIN_VALUE);
		int minInt = -2147483648;
		System.out.println(minInt);
		System.out.println(minInt-1); // underflow
...
//		maxDouble = 1.7976931348623157E309D; // error
		...
		System.out.println("underflow minus : "+(minFloat - 2F));
		System.out.println("underflow plus : "+(minFloat + 2F));
		System.out.println("underflow underflow : "+(minFloat + minFloat));
		System.out.println(minFloat);
//		minFloat = -1.4E-46F; // error
		
		System.out.println(Float.MAX_VALUE);
		float maxFloat = 3.4028235E38F;
		System.out.println("overflow "+(maxFloat * 2F)); // Infinity
		System.out.println(maxFloat);
//		maxFloat = 3.4028235E39F; // error
		
		BigInteger bi1 = new BigInteger(""); 
