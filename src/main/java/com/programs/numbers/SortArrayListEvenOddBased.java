...
public class SortArrayListEvenOddBased {
	public static void main(String[] args) {
		...
		integers.add(22);integers.add(21);integers.add(13);integers.add(8);integers.add(5);integers.add(18);integers.add(9);integers.add(8);integers.add(1);integers.add(19);
